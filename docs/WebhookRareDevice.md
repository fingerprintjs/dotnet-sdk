# FingerprintPro.ServerSdk.Model.WebhookRareDevice
## Properties
...
**PercentileBucket** | **string** | The rarity percentile bucket of the device, indicating how uncommon the device configuration is compared to all observed devices.  | [optional] 
