...
namespace Fingerprint.ServerSdk.Api
{
    ...
    public interface IFingerprintApi : IApi
    {
        ...
        // Ok() is now an Event oneOf wrapper. response.Ok().Identification no longer compiles.
    ...
    public class SearchEventsRequest
    {
        ...
        /// </summary>
        public Option<string> HighRecallId { get; set; } = default;
        ...
        /// <summary>
        /// Filter events by their Bot Info result, specifically:   - `all` - events where any kind of bot was detected.   - `none` - events where no bot was detected, and no `bot_info` was present.  (optional)
        /// </summary>
        ...
        private Option<DateTimeOffset> _startDateTime;
        ...
        /// </summary>
        /// <seealso cref="Start"/>
        public Option<DateTimeOffset> StartDateTime
        {
            get
            {
        ...
        /// <summary>
        /// Include events that happened before this point (with timestamp less than or equal to the provided `end` Unix milliseconds value). Defaults to now. Setting `end` does not change the default of `7 days ago` for `start`/`start_date_time` — adjust it separately if needed. (optional)
        ///
        ...
        private Option<DateTimeOffset> _endDateTime;
        ...
        /// </summary>
        /// <seealso cref="End"/>
        public Option<DateTimeOffset> EndDateTime
        {
            get
            {
                return _endDateTime;
        ...
        /// <summary>
        /// Filter events by Browser Tampering Detection result. > Note: When using this parameter, only events with the `tampering` property set to `true` or `false` are returned. Events without a `tampering` Smart Signal result are left out of the response.  (optional)
        /// </summary>
        public Option<bool> Tampering { get; set; } = default;

        /// <summary>
        /// Filter events by Anti-detect Browser Detection result. > Note: When using this parameter, only events with the `tampering_details.anti_detect_browser` property set to `true` or `false` are returned. Events without a `tampering` Smart Signal result are left out of the response.  (optional)
        /// </summary>
        ...
        /// <summary>
        /// Filter events by Factory Reset Detection result. > Note: When using this parameter, only events with a `factory_reset_timestamp` property populated are included. Events without a `factory_reset_timestamp` Smart Signal result are left out of the response.  (optional)
        /// </summary>
        ...
        /// <summary>
        /// Filter events by their incremental identification status (`incremental_identification_status` property). Non incremental identification events are left out of the response.  (optional)
        /// </summary>
        public Option<SearchEventsIncrementalIdentificationStatus> IncrementalIdentificationStatus { get; set; } = default;

        /// <summary>
        /// Filter events by iOS Simulator Detection result.  > Note: When using this parameter, only events with the `simulator` property set to `true` or `false` are returned. Events without a `simulator` Smart Signal result are left out of the response.  (optional)
        /// </summary>
        public Option<bool> Simulator { get; set; } = default;

        /// <summary>
        /// Filter events by Active Call Detection result on mobile devices.  > Note: When using this parameter, only events with the `active_call` property set to `true` or `false` are returned. Events without an `active_call` Smart Signal result are left out of the response.  (optional)
        /// </summary>
        public Option<bool> ActiveCall { get; set; } = default;
        ...
        /// <summary>
        /// Sets the highRecallId parameter.
        /// </summary>
        /// <param name="value">The High Recall ID is a supplementary browser identifier designed for use cases that require wider coverage over precision. Compared to the standard visitor ID, the High Recall ID strives to match incoming browsers more generously (rather than precisely) with existing browsers and thus identifies fewer browsers as new. The High Recall ID is best suited for use cases that are sensitive to browsers being identified as new and where mismatched browsers are not detrimental.  Filter events by matching High Recall ID (`supplementary_id_high_recall.visitor_id` property). </param>
        /// <returns>This request instance for fluent chaining.</returns>
        public SearchEventsRequest WithHighRecallId(string value)
        {
            HighRecallId = new Option<string>(value);
            return this;
        }
        ...
        /// </summary>
        /// <param name="value">Filter events by their Bot Info result, specifically:   - `all` - events where any kind of bot was detected.   - `none` - events where no bot was detected, and no `bot_info` was present. </param>
        /// <returns>This request instance for fluent chaining.</returns>
        ...
        /// StartDateTime is an alias for Start. Setting StartDateTime will clear an existing value for Start.
        /// </summary>
        /// <param name="value">Include events that happened after this point (with timestamp greater than or equal to the provided `start_date_time` RFC3339 timestamp). Defaults to 7 days ago. Setting `start_date_time` does not change the default of `now` for `end`/`end_date_time` — adjust it separately if needed. This parameter is an alias for `start`.</param>
        /// <returns>This request instance for fluent chaining.</returns>
        public SearchEventsRequest WithStartDateTime(DateTimeOffset value)
        {
            StartDateTime = new Option<DateTimeOffset>(value);
            return this;
        }
        ...
        /// End is an alias for EndDateTime. Setting End will clear an existing value for EndDateTime.
        /// </summary>
        /// <param name="value">Include events that happened before this point (with timestamp less than or equal to the provided `end` Unix milliseconds value). Defaults to now. Setting `end` does not change the default of `7 days ago` for `start`/`start_date_time` — adjust it separately if needed.</param>
        /// <returns>This request instance for fluent chaining.</returns>
        ...
        /// EndDateTime is an alias for End. Setting EndDateTime will clear an existing value for End.
        /// </summary>
        /// <param name="value">Include events that happened before this point (with timestamp less than or equal to the provided `end_date_time` RFC3339 timestamp). Defaults to now. Setting `end_date_time` does not change the default of `7 days ago` for `start`/`start_date_time` — adjust it separately if needed. This parameter is an alias for `end`.</param>
        /// <returns>This request instance for fluent chaining.</returns>
        public SearchEventsRequest WithEndDateTime(DateTimeOffset value)
        {
            EndDateTime = new Option<DateTimeOffset>(value);
            return this;
        }
        ...
        /// </summary>
        /// <param name="value">Filter events by Browser Tampering Detection result. > Note: When using this parameter, only events with the `tampering` property set to `true` or `false` are returned. Events without a `tampering` Smart Signal result are left out of the response. </param>
        /// <returns>This request instance for fluent chaining.</returns>
        ...
        /// </summary>
        /// <param name="value">Filter events by Anti-detect Browser Detection result. > Note: When using this parameter, only events with the `tampering_details.anti_detect_browser` property set to `true` or `false` are returned. Events without a `tampering` Smart Signal result are left out of the response. </param>
        /// <returns>This request instance for fluent chaining.</returns>
        ...
        /// </summary>
        /// <param name="value">Filter events by Factory Reset Detection result. > Note: When using this parameter, only events with a `factory_reset_timestamp` property populated are included. Events without a `factory_reset_timestamp` Smart Signal result are left out of the response. </param>
        /// <returns>This request instance for fluent chaining.</returns>
        ...
        {
            RareDevice = new Option<bool>(value);
            return this;
        }
        ...
        {
            RareDevicePercentileBucket = new Option<SearchEventsRareDevicePercentileBucket>(value);
            return this;
        }
        ...
        /// </summary>
        /// <param name="value">Filter for events by providing one or more environment IDs (`environment_id` property).  ### Array syntax To provide multiple environment IDs, use the repeated keys syntax (`environment=env1&environment=env2`). Other notations like comma-separated (`environment=env1,env2`) or bracket notation (`environment[]=env1&environment[]=env2`) are not supported. </param>
        /// <returns>This request instance for fluent chaining.</returns>
        ...
        /// <summary>
        /// Sets the incrementalIdentificationStatus parameter.
        /// </summary>
        /// <param name="value">Filter events by their incremental identification status (`incremental_identification_status` property). Non incremental identification events are left out of the response. </param>
        /// <returns>This request instance for fluent chaining.</returns>
        public SearchEventsRequest WithIncrementalIdentificationStatus(SearchEventsIncrementalIdentificationStatus value)
        {
            IncrementalIdentificationStatus = new Option<SearchEventsIncrementalIdentificationStatus>(value);
            return this;
        }

        /// <summary>
        /// Sets the simulator parameter.
        /// </summary>
        /// <param name="value">Filter events by iOS Simulator Detection result.  > Note: When using this parameter, only events with the `simulator` property set to `true` or `false` are returned. Events without a `simulator` Smart Signal result are left out of the response. </param>
        /// <returns>This request instance for fluent chaining.</returns>
        public SearchEventsRequest WithSimulator(bool value)
        {
            Simulator = new Option<bool>(value);
            return this;
        }

        /// <summary>
        /// Sets the activeCall parameter.
        /// </summary>
        /// <param name="value">Filter events by Active Call Detection result on mobile devices.  > Note: When using this parameter, only events with the `active_call` property set to `true` or `false` are returned. Events without an `active_call` Smart Signal result are left out of the response. </param>
        /// <returns>This request instance for fluent chaining.</returns>
        public SearchEventsRequest WithActiveCall(bool value)
        {
            ActiveCall = new Option<bool>(value);
            return this;
        }
        ...
        /// </summary>
        /// <param name="value">Selects the source of events to search. When omitted, only traditional identification events generated from devices are returned (the default behavior). When set to `edge`, only Automation Intelligence (Edge) events are returned.  To retrieve all events regardless of source, you must make two requests. One with the `source` parameter set to `edge`, and another with the `source` parameter omitted.  > Note: The Automation Intelligence API is in public preview testing phase.  If you encounter any issues, please [contact](https://fingerprint.com/support/) our support team. </param>
        /// <returns>This request instance for fluent chaining.</returns>
    ...
    public sealed partial class FingerprintApi : IFingerprintApi
    {
        ...
        /// <summary>
        /// Get an event by event ID Get a detailed analysis of an individual event, including Smart Signals.  Use `event_id` as the URL path parameter. This API method is scoped to a request, i.e. all returned information is by `event_id`.  Returns `EventDevice` when `source` is `device`, and `EventEdge` when `source` is `edge`. 
        /// </summary>
        /// <param name="eventId">The unique [identifier](https://docs.fingerprint.com/reference/js-agent-get-function#event_id) of each identification request (`requestId` can be used in its place).</param>
        /// <param name="rulesetId">The ID of the ruleset to evaluate against the event, producing the action to take for this event. The resulting action is returned in the `rule_action` attribute of the response.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        ...
        public partial class GetEventApiResponse : Fingerprint.ServerSdk.Client.ApiResponse, IGetEventApiResponse
        {
            ...
            /// </summary>
            /// <returns></returns>
            public Fingerprint.ServerSdk.Model.ErrorResponse GatewayTimeout()
            {
                // This logic may be modified with the AsModel.mustache template
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryGatewayTimeout(out Fingerprint.ServerSdk.Model.ErrorResponse result)
            {
                result = null;
        ...
        public async Task<ISearchEventsApiResponse> SearchEventsAsync(SearchEventsRequest request, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            Option<DateTimeOffset> startDateTime = request.StartDateTime;
            Option<long> end = request.End;
            Option<DateTimeOffset> endDateTime = request.EndDateTime;
            ...
            Option<bool> rareDevice = request.RareDevice;
            Option<SearchEventsRareDevicePercentileBucket> rareDevicePercentileBucket = request.RareDevicePercentileBucket;
            ...
            Option<bool> activeCall = request.ActiveCall;
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    if (highRecallId.IsSet)
                        parseQueryStringLocalVar["high_recall_id"] = ClientUtils.ParameterToString(highRecallId.Value);
                    ...
                    if (rareDevice.IsSet)
                        parseQueryStringLocalVar["rare_device"] = ClientUtils.ParameterToString(rareDevice.Value);

                    if (rareDevicePercentileBucket.IsSet)
                        parseQueryStringLocalVar["rare_device_percentile_bucket"] = ClientUtils.ParameterToString(rareDevicePercentileBucket.Value);
                    ...
                    if (incrementalIdentificationStatus.IsSet)
                        parseQueryStringLocalVar["incremental_identification_status"] = ClientUtils.ParameterToString(incrementalIdentificationStatus.Value);

                    if (simulator.IsSet)
                        parseQueryStringLocalVar["simulator"] = ClientUtils.ParameterToString(simulator.Value);

                    if (activeCall.IsSet)
                        parseQueryStringLocalVar["active_call"] = ClientUtils.ParameterToString(activeCall.Value);
