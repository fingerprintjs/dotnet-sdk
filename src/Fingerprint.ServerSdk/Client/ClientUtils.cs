...
namespace Fingerprint.ServerSdk.Client
{
    ...
    public static class ClientUtils
    {
        ...
        /// </summary>
        public const string ClientVersion = "8.3.0";
        ...
        public static string ParameterToString(object obj, string format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is SearchEventsSource searchEventsSource)
                return SearchEventsSourceValueConverter.ToJsonValue(searchEventsSource);
