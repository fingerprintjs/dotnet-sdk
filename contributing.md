...
- [template](./template) - folder contains redefined templates of `openapi-generator`. Original templates you can find in [openapi-generator repo](https://github.com/OpenAPITools/openapi-generator/tree/v7.23.0/modules/openapi-generator/src/main/resources/csharp).
